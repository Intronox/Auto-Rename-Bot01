...
class Config(object):
    # pyro client config
    API_ID    = os.environ.get("16510180", "")
    API_HASH  = os.environ.get("97d3a727651ab860c8f3a69d528f7018", "")
    BOT_TOKEN = os.environ.get("7391505685:AAErvFyze5UfZYWwZWsmQgIlrZ8rI1NKwf0", "") 
